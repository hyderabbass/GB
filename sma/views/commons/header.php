    ...
    <ul class="menu nav nav-tabs nav-stacked">
      <li class="dropdown"><a class="showSubMenus" href="#productsMenu"><i class="icon-barcode icon-white"></i> <?php echo $this->lang->line('products'); ?> <b class="caret"></b></a>
        <ul class="nav nav-tabs nav-stacked sub-menu" id="productsMenu">
          ...
          <li class="divider"></li>
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=promotions"><?php echo $this->lang->line('list_promotions'); ?></a></li>
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=promotions&amp;view=add"><?php echo $this->lang->line('add_promotion'); ?></a></li>
        </ul>
      </li>
      <li class="dropdown"><a class="showSubMenus" href="#itemkitsMenu"><i class="icon-exclamation-sign icon-white"></i> <?php echo $this->lang->line('itemkits'); ?> <b class="caret"></b></a>
        <ul class="nav nav-tabs nav-stacked sub-menu" id="itemkitsMenu">
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=itemkits&amp;view=add"><?php echo $this->lang->line('add_itemkits'); ?></a></li>
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=itemkits"><?php echo $this->lang->line('list_itemkits'); ?></a></li>
        </ul>
      </li>
      ...
      <li class="dropdown"><a class="showSubMenus" href="#salesMenu"><i class="icon-heart  icon-white"></i> <?php echo $this->lang->line('sales'); ?> <b class="caret"></b></a>
        <ul class="nav nav-tabs nav-stacked sub-menu" id="salesMenu">
          ...
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=pos"><?php echo $this->lang->line('add_invoice'); ?></a></li><!-- Hyder - redirect lr POS screen - lot version la in tirer .-->
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=archives"><?php echo $this->lang->line('list_deleted_invoices'); ?></a></li>
     ...
     <!-- <li class="dropdown"><a class="showSubMenus" href="#quotesMenu"><i class="icon-exclamation-sign icon-white"></i> <?php echo $this->lang->line('quotes'); ?> <b class="caret"></b></a>
      ...
      <li class="dropdown"><a class="showSubMenus" href="#reportsMenu"><i class="icon-tasks  icon-white"></i> <?php echo $this->lang->line('reports'); ?> <b class="caret"></b></a>
        <ul class="nav nav-tabs nav-stacked sub-menu" id="reportsMenu">
          ...
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=promoalerts"><?php echo $this->lang->line('promotion_alerts'); ?></a></li>
          ...
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=reports&view=dailysalesreport"><?php echo $this->lang->line('daily_sales_report'); ?></a></li>
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=reports&view=creditcustomer"><?php echo $this->lang->line('list_of_debtors'); ?></a></li>
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=profits"><?php echo $this->lang->line('profit_and_loss'); ?></a></li>
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=reports&view=bestresult"><?php echo $this->lang->line('best_result'); ?></a></li>
          ...
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=reports&view=pendingcustomer"><?php echo $this->lang->line('pending_customer'); ?></a></li>
          <li><a href="<?php echo $this->config->base_url(); ?>index.php?module=reports&view=consultant"><?php echo $this->lang->line('consultant_per_teamleader'); ?></a></li>
        </ul>
      </li>
    </ul>
    <?php } ?>
