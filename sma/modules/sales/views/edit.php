<?php $reference_no = array(
            ...
            $coordinator_name = array(
              ...
              'id'          => 'coordinator_name',
              'value'       => $inv->coordinator_name,
              'class'       => 'span4'
            );
            $driver_name = array(
              'name'        => 'driver_name',
              'id'          => 'driver_name',
              'value'       => $inv->driver_name,
              'class'       => 'span4'
            );
            $served_by = array(
              'name'        => 'served_by',
...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input('coordinator_name', (isset($_POST['coordinator_name']) ? $_POST['coordinator_name'] : $inv->coordinator_name), 'class="span4 tip" id="coordinator_name" required="required" data-error="'.$this->lang->line("coordinator_name").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
<div class="control-group">
  <label class="control-label" for="driver_name"><?php echo $this->lang->line("driver_name"); ?></label>
  <div class="controls"> <?php echo form_input('driver_name', (isset($_POST['driver_name']) ? $_POST['driver_name'] : $inv->driver_name), 'class="span4 tip" id="driver_name" required="required" data-error="'.$this->lang->line("driver_name").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
<div class="control-group">
...
echo form_dropdown('payment_type', $pl, (isset($_POST['payment_type']) ? $_POST['payment_type'] : $inv->payment_id), 'id="payment_type_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("payment_type").'" required="required" data-error="'.$this->lang->line("payment_type").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
-->
  ...
  <div class="controls">  <?php 
	 $pl[""] = "";
	   		foreach($deliver_types as $deliver_type){
				$pl[$deliver_type->id] = $deliver_type->name;
			}
		echo form_dropdown('deliver_type', $pl, (isset($_POST['deliver_type']) ? $_POST['deliver_type'] : $inv->deliver_id), 'id="deliver_type_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("deliver_type").'" required="required" data-error="'.$this->lang->line("deliver_type").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
  ...
  <div class="controls">  <?php 
	 $bls[""] = "";
	   		foreach($due_dates as $due_date){
				$bls[$due_date->id] = $due_date->name;
			}
		echo form_dropdown('due_date', $bls, (isset($_POST['due_date']) ? $_POST['due_date'] : $inv->due_id), 'id="due_date_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("due_date").'" required="required" data-error="'.$this->lang->line("due_date").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
...
<div class="control-group">
  ...
  <div class="controls">  <?php 
	 $plt[""] = "";
		...
		echo form_dropdown('order_type', $plt, (isset($_POST['order_type']) ? $_POST['order_type'] : $inv->order_id), 'id="order_type_s" data-placeholder="'.$this->lang->line("select").' '.$this->lang->line("order_type").'" required="required" data-error="'.$this->lang->line("order_type").' '.$this->lang->line("is_required").'"'); ?> </div>
</div>
<div class="control-group">
  <label class="control-label" for="served_by"><?php echo $this->lang->line("served_by"); ?></label>
  <div class="controls"> <?php echo form_input('served_by', (isset($_POST['served_by']) ? $_POST['served_by'] : $inv->served_by), 'class="span4 tip" id="served_by" "'); ?> </div>
</div>
