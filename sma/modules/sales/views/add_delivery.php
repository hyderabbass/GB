...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input('coordinator_name', (isset($_POST['coordinator_name']) ? $_POST['coordinator_name'] : $inv->coordinator_name), 'class="span4" id="coordinator_name" required="required" data-error="'.$this->lang->line("coordinator_name").' '.$this->lang->line("is_required").'"');?></div>
</div>

<div class="control-group">
  <label class="control-label" for="driver_name"><?php echo $this->lang->line("driver_name"); ?></label>
  <div class="controls"> <?php echo form_input('driver_name', (isset($_POST['driver_name']) ? $_POST['driver_name'] : $inv->driver_name), 'class="span4" id="driver_name" required="required" data-error="'.$this->lang->line("driver_name").' '.$this->lang->line("is_required").'"');?></div>
</div>
