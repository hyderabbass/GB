<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=itemkits&view=getitemkits',
...
<?php if($success_message) { echo "<div class=\"alert alert-success\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $success_message . "</div>"; } ?>
	...
	<table id="fileData" class="table table-bordered table-hover table-striped table-condensed" style="margin-bottom: 5px;">
        ...
        <tr>
            ...
            <th><?php echo $this->lang->line("new_price"); ?></th>
			<!--<th>note</th>-->
	...
	<a href="<?php echo site_url('module=itemkits&view=add');?>" class="btn btn-primary"><?php echo $this->lang->line("add_itemkit"); ?></a>