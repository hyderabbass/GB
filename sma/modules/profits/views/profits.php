...
.table td:nth-child(2), .table tfoot th:nth-child(2), .table td:nth-child(3), .table tfoot th:nth-child(3), .table td:nth-child(4), .table tfoot th:nth-child(4) {
	text-align:right;
}
</style>
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=profits&view=getprofits',
...
<table id="fileData" class="table table-bordered table-hover table-striped table-condensed" style="margin-bottom: 5px;">
  <thead>
    <tr>
      ...
      <th><?php echo $this->lang->line("itemkit_no"); ?></th>
      <th><?php echo $this->lang->line("itemkit_name"); ?></th>
  ...
  <tbody>
    <tr>
      <td colspan="5" class="dataTables_empty"><?php echo $this->lang->line("loading_data"); ?></td>
    </tr>
  </tbody>
  <tfoot>
    <tr>
