...
<div class="control-group">
  <label class="control-label" for="gift_one"><?php echo $this->lang->line("gift_one"); ?></label>
  <div class="controls"> <?php echo form_input($gift_one); ?> </div>
</div>
<div class="control-group">
  <label class="control-label" for="gift_two"><?php echo $this->lang->line("gift_two"); ?></label>
  <div class="controls"> <?php echo form_input($gift_two); ?> </div>
</div>
<div class="control-group">
  <label class="control-label" for="gift_three"><?php echo $this->lang->line("gift_three"); ?></label>
  <div class="controls"> <?php echo form_input($gift_three); ?> </div>
</div>
<div class="control-group">
