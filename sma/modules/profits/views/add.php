...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input($itemkit_unit, (isset($_POST['itemkit_unit']) ? $_POST['itemkit_unit'] : ""), 'class="span4" id="itemkit_unit" required="required" data-error="'.$this->lang->line("itemkit_unit").' '.$this->lang->line("is_required").'"');?></div>
</div>
<!--<?php if(TAX2) { ?>
<div class="control-group">
  ...
  <?php 
	 ...
	 $whx1[''] = '';
	  foreach($products as $product_name){
 		   $whx1[$product_name->name] = $product_name->name;
		}
...
<div class="control-group">
  ...
  <?php 
	 ...
	 $whx2[''] = '';
	  foreach($products as $product_name){
 		   $whx2[$product_name->name] = $product_name->name;
		}
...
<div class="control-group">
  ...
  <?php 
	 ...
	 $whx3[''] = '';
	  foreach($products as $product_name){
 		   $whx3[$product_name->name] = $product_name->name;
		}
