...
class Products extends MX_Controller
{
    ...
    */
    ...
    function getdatatableajaxcost()
    {
        ...
        $this->datatables
            ...
            ->where('products.itemkit_id = "0"') /* Issue#1 - Hyder - 21 July 2014 - Mone ajoute sa pu exclude item kits dans la list produit.. */
    ...
    function getdatatableajax()
    {
        ...
        $this->datatables->group_by("products.category_id"); /*#####################Abdallah - issue #28 - 08-07-2014  - START##################*/
    ...
    */
    ...
    /* ---------------------------------------------------------------------------------------------------------------------------------------------------------------- */
    /*#############################################################################*/
    /*#####################Abdallah - issue #28 - 09-07-2014  - START##############*/
    /*#############################################################################*/
    function add()
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            /*#############################################################################*/
            /*#####################Abdallah - issue #28 - 09-07-2014  - END################*/
            /*#############################################################################*/
        ...
        if ($this->form_validation->run() == true && $this->products_model->addProduct($code, $name, $photo, $data)) {
            ...
            $data['menus'] = $this->products_model->getAllMenus(); /*#####################Abdallah - issue #28 - 08-07-2014  - START##################*/
    ...
    function edit()
    {
        ...
        $this->form_validation->set_rules('name', $this->lang->line("product_name"), 'required|xss_clean');
        $this->form_validation->set_rules('category', $this->lang->line("cname"), 'required|xss_clean');
        $this->form_validation->set_rules('sub_category', $this->lang->line("subcategory"), 'xss_clean');
        $this->form_validation->set_rules('unit', $this->lang->line("product_unit"), 'required|xss_clean');
        ...
        if ($this->form_validation->run() == true && $this->products_model->updateProduct($id, $photo, $data)) {
            ...
            #############################################################################
            */
            $product_infos = $this->products_model->getProductInfoByID($id);
            $data['menus'] = $this->products_model->getAllMenus();
            $data['subbrand'] = $this->products_model->getAllSubBrand();
            $data['subcategories'] = $this->products_model->getSubCategoriesByMenuId($product_details->category_id);
            $data['product'] = $product_infos;
            $dat['productdetails'] = $product_infos;
            /*
           ################################################################################
           #####################Abdallah - issue #11 - 10-07-2014  - END###################
           ################################################################################
    ...
    function getSubCategories()
    {
        ...
        if ($rows = $this->products_model->getSubCategoriesByMenuId($category_id)) { /*#####################Abdallah - issue #28 - 07-07-2014  - START##################*/
            $ct[""] = '';
