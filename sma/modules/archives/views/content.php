...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=archives&view=getdatatableajax',
					...
					"oTableTools": {
						...
						"aButtons": [
								{
									"sExtends": "csv",
									"sFileName": "<?php echo $this->lang->line("archives"); ?>.csv",
                   		 			"mColumns": [ 0, 1, 2, 3, 4, 5, 6 ]
								},
								{
									"sExtends": "pdf",
									"sFileName": "<?php echo $this->lang->line("archives"); ?>.pdf",
					...
					"aoColumns": [ 
					  { "mRender": format_date },  null,  null, null, null, { "mRender": currencyFormate }, { "mRender": currencyFormate },
					  { "bSortable": false }
					],
