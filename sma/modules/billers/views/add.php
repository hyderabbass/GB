...
<div class="control-group">
  ...
  <div class="controls"> <input type="tel" name="phone" class="span4" pattern="[0-7]{5,15}" />
  </div>
</div>
<div class="control-group">
  <label class="control-label" for="mobile_number"><?php echo $this->lang->line("mobile_number"); ?></label>
  <div class="controls"> <input type="tel" name="mobile_number" class="span4" pattern="[0-9]{7,15}" required="required" data-error="<?php echo $this->lang->line("mobile_number").' '.$this->lang->line("is_required"); ?>" />
  </div>
</div> 
<div class="control-group">
  <label class="control-label" for="fax"><?php echo $this->lang->line("fax"); ?></label>
  <div class="controls"> <input type="tel" name="fax" class="span4" pattern="[0-9]{7,15}" />
  </div>
</div>
<div class="control-group">
  <label class="control-label" for="company"><?php echo $this->lang->line("company"); ?></label>
  <div class="controls"> <?php echo form_input($company, '', 'class="span4 tip" title="'.$this->lang->line("bypass").'" id="company" pattern=".{1,55}" "');?>
  </div>
</div> 
<div class="control-group">
...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input($city, '', 'class="span4" id="city" pattern=".{2,55}" ');?>
  </div>
</div> 
...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input($country, '', 'class="span4" id="country" pattern=".{2,55}"');?>
  </div>
</div> 
<div class="control-group">
  ...
  <div class="controls">  
	  ...
	  $biller_logos[''] = ''; 
		...
		echo form_dropdown('logo', $biller_logos, '', 'data-placeholder="'.$this->lang->line("select")." ".$this->lang->line("biller_logo").'" '); ?> </div>
</div>
<!--<div class="control-group">
