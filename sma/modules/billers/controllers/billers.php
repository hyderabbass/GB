...
*/
	...
	function getdatatableajax()
   {
	...
	function add()
	{
		...
		$this->form_validation->set_rules('email', $this->lang->line("email_address"), 'xss_clean|valid_email');
		...
		$this->form_validation->set_rules('phone', $this->lang->line("phone"), 'xss_clean|min_length[7]|max_length[16]');
        $this->form_validation->set_rules('mobile_number', $this->lang->line("mobile_number"), 'required|xss_clean|min_length[7]|max_length[16]');
		$this->form_validation->set_rules('fax', $this->lang->line("fax"), 'xss_clean|min_length[7]|max_length[16]');
	...
	function edit($id = NULL)
	{
		...
		$this->form_validation->set_rules('country', $this->lang->line("country"), 'xss_clean');
		$this->form_validation->set_rules('phone', $this->lang->line("phone"), 'xss_clean|min_length[7]|max_length[16]');
        $this->form_validation->set_rules('mobile_number', $this->lang->line("mobile_number"), 'required|xss_clean|min_length[8]|max_length[16]');
        $this->form_validation->set_rules('fax', $this->lang->line("fax"), 'xss_clean|min_length[8]|max_length[16]');
        $this->form_validation->set_rules('logo', $this->lang->line("logo"), 'xss_clean');
		$this->form_validation->set_rules('invoice_footer', $this->lang->line("invoice_footer"), 'xss_clean');
