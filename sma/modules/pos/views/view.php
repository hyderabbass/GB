...
<html>
<head>
    <!--Yogesh - issue #css changed completely - 08-07-2014 - START-->
    <meta charset="utf-8">
    ...
    <style type="text/css">
        html, body {
          /*  height: 100%; - sa kk la p fr invoice la sorti lr 2 page . - Hyder - 14 June 2014 - issue #41 */
            font-size: 12px;
    ...
    <!--Yogesh - issue #30 - 08-07-2014  - css END -->
</head>
...
<div class="row-fluid">
	...
	<br /><br />" . $this->lang->line("tel") . ": " . $biller->phone . "<br /><br />" . $this->lang->line("fax") . ": " . $biller->fax . "<br /><br />" . $this->lang->line("mobile") . ": " . $biller->mobile_number . "<br /><br />" . $this->lang->line("email") . ": " . $biller->email;
        ...
        # Hyder - START - #29
        if (!$teamleader) { // veu dir li em li n TL
            $teamleader_name = $customer->name . ' ' . $customer->surname;
        } else {
            $teamleader_name = $teamleader->name . ' ' . $teamleader->surname;
        }
        # Hyder - END - #29
        ...
        {
            echo "<br /><br />" . $this->lang->line("teamleader") . ": " . $teamleader_name;
        }
        //{ echo "<br />".$this->lang->line("reference_no").": ".$inv->reference_no; }
        {
            echo "<br /><br />" . $this->lang->line("deliver_type") . ": " . $inv->deliver_type;
        }
        {
            echo "<br /><br /> Order type : " . $inv->order_type . "(" . $inv->served_by . ")";
        }
        {
            echo "<br /><br />" . $this->lang->line("due_date") . ": " . date("jS F, Y", strtotime($inv->due_date));
        }
        {
            echo "<br /><br />" . "Date Issued " . ": " . date("jS F, Y", strtotime($inv->date));
        }
        /* Yogesh - issue #30 - 04-07-2014  - END */
        echo "</p>";
        ?>

        <!--Yogesh - issue #Change Invoice.No to GB.No on invoice - 08-07-2014 - START-->
        <div class="span6">
            <h4 class="inv"><?php echo "" . " GB " . $this->lang->line("no") . " " . $inv->id; ?></h4>
        </div>
    ...
    <div class="pull-right">
        ...
        <!--Yogesh - issue #Change customer to consultant - 08-07-2014 - START-->
        <p><?php if ($customer->company != "-") {
                echo "<p align=left>Consultant Name: " . $customer->name . ' ' . $customer->surname . "</p>";
            } ?>
            <!--Yogesh - issue #30 - 08-07-2014  - END -->
        ...
        <p style="text-align: left;"><?php if ($customer->address != "-") {
            ...
            <!--    <p style="text-align: left;"> <?php echo $this->lang->line("customer_id") . ": " . $customer->id; ?>  <!-- Yogesh in dir pas servi sa - Hyder - 14 June 2014 -->
...
<!-- Yogesh - issue #Add break tag and swap owner and customer - 04-07-2014 - START-->
</br>
</br>
</br>
<div class="row-fluid">
...
<!-- Yogesh - issue #Add approved_by_credit_controller - 04-07-2014 - - Modified by Hyder - 14 June 2014 - Credit controller Not aligned! START-->
<div class="row-fluid">
    <div class="span5 ">
        <p>&nbsp;</p>
...
<!-- Yogesh - issue #Add add footer text - 04-07-2014 - START-->
...
<div id="buttons" style="padding-top:10px; text-transform:uppercase;">
        <span class="left"><a href="<?php echo base_url(); ?>index.php?module=pos"
