...
<p>&nbsp;</p> 
	...
	<?php $r = 1; foreach ($rows as $row):?>
			<tr>
                ...
                <td style="width: 100px; text-align:center; vertical-align:middle;"><?php echo $row->batch_number; ?></td>
                <td style="width: 100px; text-align:center; vertical-align:middle;"><?php echo date(PHP_DATE, strtotime($row->expiry_date)); ?></td>
    ...
    <?php 
		...
		endforeach;
	?>
<tr><td colspan="6" style="text-align:right; padding-right:10px; font-weight:bold;"><?php echo $this->lang->line("total_amount"); ?> (<?php echo CURRENCY_PREFIX; ?>)</td><td style="text-align:right; padding-right:10px; font-weight:bold;"><?php echo $this->ion_auth->formatMoney($inv->total); ?></td></tr>
