...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
  ...
  <div class="well well-small">
    ...
    <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br /><?php echo $this->lang->line("csv2"); ?> <span class="text-info">(<?php echo $this->lang->line("quantity"); ?>, <?php echo $this->lang->line("batch_number"); ?>, <?php echo $this->lang->line("expiry_date"); ?>, <?php echo $this->lang->line("product_code"); ?>, <?php echo $this->lang->line("unit_price"); ?>)</span> <?php echo $this->lang->line("csv3"); ?>
   </div>
