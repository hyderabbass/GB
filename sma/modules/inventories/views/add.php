...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //  Issue #13 - Hyder - 30 June 2014 - Datepicker issue - pas servi sa boute code la apparement
        newTr.html('<td><input name="product' + count + '" type="hidden" value="' + item_code + '"><input class="span5 tran" style="text-align:left;" name="item' + count + '" type="text" value="' + item_name + ' (' + item_code + ')"></td><td><input class="span2 tran" name="quantity' + count + '" type="text" value="1" onClick="this.select();"></td><td><input class="span2 tran" name="batch_number' + count + '" type="text" value="-" onClick="this.select();"></td><td><input class="span2 tran expiry_date" name="expiry_date' + count + '" type="text" value="yyyy-mm-dd" onClick="this.select();"></td><td><input class="span2 tran" style="text-align:right;" name="unit_cost' + count + '" type="text" value="' + item_cost + '"></td><td><i class="icon-trash tip del" id="' + count + '" title="Remove this Item" style="cursor:pointer;" data-placement="right"></i></td>');
    ...
    //  Issue #13 - Hyder - 30 June 2014 - Datepicker issue - referenced in app.js
    var newTr = $('<tr id="row_' + count + '"></tr>');
    newTr.html('<td><input name="product' + count + '" type="hidden" value="' + item_code + '"><input class="span5 tran" style="text-align:left;" name="item' + count + '" type="text" value="' + item_name + ' (' + item_code + ')"></td><td><input class="span2 tran" name="quantity' + count + '" type="text" value="1" onClick="this.select();"></td><td><input class="span2 tran" name="batch_number' + count + '" type="text" value="-" onClick="this.select();"></td><td>         <input class="booh span2 tran" id="expi_date" name="expiry_date' + count + '" type="text"  ></td><td><input class="span2 tran" style="text-align:right;" name="unit_cost' + count + '" type="text" value="' + item_cost + '"></td><td><i class="icon-trash tip del" id="' + count + '" title="Remove this Item" style="cursor:pointer;" data-placement="right"></i></td>');
    newTr.appendTo("#dyTable");
...
<div class="control-group">
    ...
    <div
        ...
        <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $rnumber), 'class="span4 tip" id="reference_no" required="required" data-error="' . $this->lang->line("reference_no") . ' ' . $this->lang->line("is_required") . '"'); ?> </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <table id="dyTable" class="table items table-striped table-bordered table-condensed table-hover">
            ...
            <th class="span2"><?php echo $this->lang->line("batch_number"); ?></th>
            <th class="span2"><?php echo $this->lang->line("expiry_date"); ?></th>
...
<div class="control-group">
    ...
    <div
        class="controls"> <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : ""), 'id="note" class="input-block-level" style="margin-top: 10px; height: 100px;"'); ?> </div>
</div>
<div class="control-group">
    <div
