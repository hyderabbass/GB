...
<div class="control-group">
  ...
  <div class="controls"> <?php echo form_input($address, '', 'class="span4" pattern=".{2,55}" required="required" data-error="'.$this->lang->line("address").' '.$this->lang->line("is_required").'"');?> </div>
</div>
<div class="control-group">
  <label class="control-label" for="dob"><?php echo $this->lang->line("dob"); ?></label>
  <div class="controls"> <?php echo form_input($dob, (isset($_POST['dob']) ? $_POST['dob'] : ""), 'class="span4" id="dob" required="required" data-error="'.$this->lang->line("dob").' '.$this->lang->line("is_required").'"');?></div>
</div>
<div class="control-group">
  <label class="control-label" for="id_number"><?php echo $this->lang->line("id_number"); ?></label>
  <div class="controls"> <?php echo form_input($id_number, '', 'class="span4" pattern=".{2,55}" required="required" data-error="'.$this->lang->line("id_number").' '.$this->lang->line("is_required").'"');?> </div>
</div>
<div class="control-group">
...
<div class="control-group">
  ...
  <div class="controls"> <?php /* echo form_input($mobile, '', 'class="span4" required="required" data-error="'.$this->lang->line("mobile").' '.$this->lang->line("is_required").'"'); */?> 
  <input type="tel" name="mobile" class="span4" pattern="[0-9]{7,15}" required="required" data-error="<?php echo $this->lang->line("mobile").' '.$this->lang->line("is_required"); ?>" /></div>
</div>
<div class="control-group">
