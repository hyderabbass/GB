...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
    ...
    <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br /><?php echo $this->lang->line("csv2"); ?> <span class="text-info">(<?php echo $this->lang->line("username"); ?>, <?php echo $this->lang->line("password"); ?>, <?php echo $this->lang->line("email"); ?>, <?php echo $this->lang->line("first_name"); ?>, <?php echo $this->lang->line("emergency_number"); ?>, <?php echo $this->lang->line("last_name"); ?>, <?php echo $this->lang->line("company"); ?>, <?php echo $this->lang->line("phone"); ?>, <?php echo $this->lang->line("address"); ?>, <?php echo $this->lang->line("region"); ?>,  <?php echo $this->lang->line("alternative_address"); ?>, <?php echo $this->lang->line("postal_code"); ?>, <?php echo $this->lang->line("country"); ?>, <?php echo $this->lang->line("id_number"); ?>, <?php echo $this->lang->line("religion"); ?>, <?php echo $this->lang->line("work_number"); ?>, <?php echo $this->lang->line("coordinator_name"); ?>, <?php echo $this->lang->line("place_of_work"); ?>, <?php echo $this->lang->line("no_of_work"); ?>, <?php echo $this->lang->line("payment_type"); ?>, <?php echo $this->lang->line("proof_of_address"); ?>, <?php echo $this->lang->line("authorization_letter"); ?>)</span> 
    
    </div>
<?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("module=auth&view=add_by_csv", $attrib); ?>
