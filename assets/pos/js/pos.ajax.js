	...
	$.ajax({
			  ...
			  success: function(data) {
					...
					var newPrs = $('
                            ...
                            if (total_cp >= <?php echo PLIMIT; ?> && p_page
                                < total_cp) {
                                    $('#gmail_loading').show();
                                    $.ajax({
                                    type: "get",
	...
	$.ajax({
			  ...
			  success: function(data) {
					...
					var newPrs = $('
                                ...
                                var newTr = $('
                                    <tr id="row_'+ count + last +'"></tr>
                                ');
                                newTr.html('
                                    <td id="satu" style="text-align:center; width: 27px;">
                                        <button type="button" class="del_row" id="del-'+ count + last +'" value="'+ item_price +'">  </button>
                                    </td>
                                    <td>
                                        <input type="text" class="code" name="product'+ count +'" value="'+ prod_name +'" id="product-'+ count + last +'"></td>
                                        <td style="text-align:center;">
                                            <input class="keyboard" name="quantity'+ count +'" type="text" value="1" id="quantity-'+ count + last +'"></td>
                                            <td>
                                                <select class="chzn-select tax" name="tax_rate'+ count +'" id="tax_rate-'+ count + last +'"><?php
			...
			?></select>
                                            ...
                                            <td style="padding-right: 10px; text-align:right;">
                                                <input type="text" class="price" name="unit_price'+ count +'" value="'+ parseFloat(item_price).toFixed(2) +'" id="price-'+ count + last +'"></td>
                                            ');
                                            ...
                                            var newTr = $('
                                                <tr id="row_'+ count + slast +'"></tr>
                                            ');
                                            newTr.html('
                                                <td id="satu" width="29px" style="text-align:center;">
                                                    <button class="del_row" id="del-'+ count + slast +'" value="'+ item_price +'"> </button>
                                                </td>
                                                <td width="144px">
                                                    <input type="text" class="code" name="product'+ count +'" value="'+ sproduct_name +'" id="product-'+ count + slast +'" />
                                                </td>
                                                <td width="44px" style="text-align:center;">
                                                    <input class="keyboard" name="quantity'+ count +'" type="text" value="1" id="quantity-'+ count + slast +'" />
                                                </td>
                                                <td>
                                                    <select class="chzn-select tax" name="tax_rate'+ count +'" id="tax_rate-'+ count + slast +'"><?php
				foreach($tax_rates as $tax) {
					echo "<option value=" . $tax->id;
					if($tax->id == DEFAULT_TAX) { echo ' selected="selected"'; }
					echo ">" . $tax->name . "</option>";
			...
			?></select>
                                                ...
                                                <td style="width: 76px; padding-right: 10px; text-align:right;">
                                                    <input type="text" class="price" name="price'+ count +'" value="'+ item_price +'" id="price-'+ count + slast +'" />
                                                </td>
                                            ');
                                            ...
                                            ');
                                            newPTDiv.html('
                                                <h3 style="line-height: 2em;">Total Payable Amount:
                                                    <span style="background: #FFFF99; padding: 5px 10px; text-weight: bold; color: #000;">'+ twt +'</span>
                                                    <br />
                                                Total Purchased Items:
                                                    <span style="background: #FFFF99; text-weight: bold; padding: 5px 10px; color: #000;">'+ count +'</span>
                                                </h3>
                                                <h3>Paid by:
                                                    <select name="paid_by" id="paid_by" class="chzn-select" style="width: 250px;">
                                                ...
                                                <div id="pcash">
                                                    <h3>Paid:
                                                        <input type="text" id="paid-amount"style="border: 1px solid #CCC; padding: 3px;" />
                                                    </h3>
                                                    <h3>Return Change:
                                                        <span style="background: #FFFF99; padding: 5px 10px; text-weight: bold; color: #000;" id="balance"></span>
                                                    </h3>
                                                </div>
                                                <button style="-moz-box-shadow:inset 0px 1px 0px 0px #caefab; -webkit-box-shadow:inset 0px 1px 0px 0px #caefab; box-shadow:inset 0px 1px 0px 0px #caefab; 	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #77d42a), color-stop(1, #5cb811) ); background:-moz-linear-gradient( center top, #77d42a 5%, #5cb811 100% ); filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=\'#77d42a\', endColorstr=\'#5cb811\'); background-color:#77d42a; border:1px solid #268a16; display:inline-block; color:#306108; padding: 10px 20px; font-weight:bold; text-decoration:none; text-shadow:1px 1px 0px #aade7c; cursor: pointer;" id="submit-sale">Submit Sale</button>
                                            ');
                                            ...
                                            beforeClose : function(e, keyboard, el, accepted) {
                                                ...
                                                if(paid < twt) {
                                                alert('Paid amount is less than the payable amount.x');
                                                $(this).val('');
                                            ...
                                            if (sec
                                                ...
                                                time = day_names[now.getDay()]+", "+now.getDate()+" "+month_names[now.getMonth()]+" "+now.getFullYear()+", "+((hour
                                                    <=9) ? "0"+hour : hour) + ":" + min + ":" + sec + " " + add;
